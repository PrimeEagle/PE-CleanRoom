local entity = 
  {
    ...
    pictures =
    {
      filename = pe.cr.path.."/graphics/entity/pe-nano-circuit-pole/pe-nano-circuit-pole.png",
      priority = "extra-high",
      width = 128,
      height = 128,
      direction_count = 1,
      ...
      hr_version = 
      {
        filename = pe.cr.path.."/graphics/entity/pe-nano-circuit-pole/hr-pe-nano-circuit-pole.png",
        priority = "extra-high",
        width = 256,
        height = 256,
        direction_count = 1,
    ...
    {
      filename = pe.cr.path.."/graphics/entity/pe-nano-circuit-pole/pe-nano-circuit-pole-radius-visualization.png",
      width = 12,
      height = 12,
