...
if not pe.lib.resource then pe.lib.resource = {} end
if not pe.lib.resources then pe.lib.resources = {} end
...
function pe.lib.resource.load_config(config)
	...
	if(pe.lib.cfg.is_valid(config) and config.enabled) then
		...
		if(not pe.lib.resources[names.internal_name]) then
			pe.lib.resources[names.internal_name] = {}
		end

		pe.lib.resources[names.internal_name].config = table.deepcopy(cfg)
	end
end
...
function pe.lib.resource.define_noise_layer(config)
	...
	pe.lib.resources[config.names.internal_name].noise_layer = table.deepcopy(noise_layer)
end
...
function pe.lib.resource.define_particle(config)
	...
	if(pe.lib.cfg.section.is_available(config, "particle")) then
		...
		pe.lib.resources[config.names.internal_name].particle = table.deepcopy(particle)
	end
end
...
function pe.lib.resource.define_item(config)
	...
	if(pe.lib.cfg.section.is_available(config, "item")) then
		...
		pe.lib.resources[config.names.internal_name].item = table.deepcopy(item)
	end
end
...
function pe.lib.resource.define_autoplace_control(config)
	...
	if(pe.lib.cfg.section.is_available(config, "autoplace_control")) then
		...
		pe.lib.resources[config.names.internal_name].autoplace_control = table.deepcopy(autoplace_control)
	end
end
...
function pe.lib.resource.define_resource(config)
	...
	if(pe.lib.cfg.section.is_available(config, "resource")) then
		...
		pe.lib.resources[config.names.internal_name].resource = table.deepcopy(resource)
	end
end
...
function pe.lib.resource.define_prototypes()
	...
	if(pe.lib.resources) then
		for k, o in pairs(pe.lib.resources) do
